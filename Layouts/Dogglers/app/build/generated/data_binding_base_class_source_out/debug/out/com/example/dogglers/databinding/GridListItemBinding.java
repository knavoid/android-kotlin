...
public final class GridListItemBinding implements ViewBinding {
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView itemDogAge,
      @NonNull TextView itemDogHobbies, @NonNull TextView itemDogName,
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GridListItemBinding((MaterialCardView) rootView, itemDogAge, itemDogHobbies,
          itemDogName, itemImage);
    }
